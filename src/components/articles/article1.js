        ...
        return(
            ...
            <div className="article">
                <section id="">
                    ...
                    <img class="center-image" src="https://assets.nhs.uk/prod/images/T_1117_healthy-eating_179013608.width-320.jpg" ></img>
                    </figure>
                </section>
                <section id="">
                    <h1>These 8 practical tips cover the basics of healthy eating and can help you make healthier choices.</h1>
                    ...
                    <p>If you eat or drink more than your body needs, you'll put on weight because the energy you do not use is stored as fat. 
                        If you eat and drink too little, you'll lose weight.</p>
                    ...
                    <p>Most adults in the UK are eating more calories than they need and should eat fewer calories.</p>
                ...
                <section >
                    ...
                    <p>Try to include at least 1 starchy food with each main meal. Some people think starchy foods are fattening, but gram for gram 
                        the carbohydrate they contain provides fewer than half the calories of fat.</p>
                    <p>Keep an eye on the fats you add when you're cooking or serving these types of foods because that's
                         what increases the calorie content – for example, oil on chips, butter on bread and creamy sauces on pasta.</p>
                </section>
                ...
                <section>
                    ...
                    <p>There are 2 main types of fat: saturated and unsaturated. Too much saturated fat can increase the amount of cholesterol 
                        in the blood, which increases your risk of developing heart disease.</p>
                    ...
                    <ul>
                        ...
                        <li>hard cheese</li>
                        <li>cream</li>
                        <li>cakes</li><li>biscuits</li><li>lard</li><li>pies</li>
                    </ul>
                    <p>Try to cut down on your >saturated fat intake and choose foods that contain unsaturated fats instead, such as vegetable oils and spreads, oily fish and avocados.</p>
                    ...
                    <p>Free sugars are any sugars added to foods or drinks, or found naturally in honey, syrups and unsweetened fruit juices and smoothies.</p><p>This is the type of sugar you should be cutting down on, rather than the sugar found in fruit and milk.</p>
                    ...
                    <ul><li>sugary fizzy drinks</li><li>sugary breakfast cereals</li><li>cakes</li>
                    <li>biscuits</li><li>pastries and puddings</li><li>sweets and chocolate</li><li>alcoholic drinks</li>
                    </ul>
                    <p>Food labels can help. Use them to check how much sugar foods contain.</p>
                    <p>More than 22.5g of total sugars per 100g means the food is high in sugar, whileg of total sugars or less per 100g means the food is low in sugar.</p>
                ...
                <section >
                    ...
                    <p>You need to drink plenty fluids to stop you getting dehydrated. The government recommends drinking 6 to 8 glasses every day.
                         This is in addition to the fluid you get from the food you eat.</p>
                ...
                <section >
                    ...
                    <p>But a healthy breakfast high in fibre and low in fat, sugar and salt can form part of a balanced diet, and can help you
                         get the nutrients you need for good health.</p>
